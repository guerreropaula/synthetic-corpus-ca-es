...
#         f"- Catalan source texts total {format_stat(stats['ca_words'])} words.",
#         f"- Spanish translations total {format_stat(stats['es_words'])} words.",
...
#             # f"  • Catalan: {format_stat(stats['aligned_corpus']['ca_tokens'])} words (raw)",
#             # f"  • Spanish: {format_stat(stats['aligned_corpus']['es_tokens'])} words (raw)",
#             "",
#         ])
...
#             [
#                 ["Catalan",  format_stat(stats["aligned_corpus"]["ca_tokens"]), format_stat(stats["aligned_corpus"]["ca_words"])],
#                 ["Spanish",  format_stat(stats["aligned_corpus"]["es_tokens"]), format_stat(stats["aligned_corpus"]["es_words"])],
#             ],
#         ))
#         lines.append("")
